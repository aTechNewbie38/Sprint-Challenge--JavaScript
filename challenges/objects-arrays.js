...
dinosaurOne.sound = "RAWERSRARARWERSARARARRRR!";
...
const unisWithUni = [];
for(let z=0; z<graduates.length; z++){
  if(graduates[z].university.includes("Uni")){
    unisWithUni.push(graduates[z].university);
  }
}
